  ...
  return (
    <footer className=" bg-black text-white p-10">
      <div className=" container mx-auto footer sm:footer-horizontal">
        ...
        <nav>
          <h6 className="font-semibold text-lg mb-6">Social</h6>
          <div className="grid grid-flow-col gap-4">
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current hover:text-[#1DA1F2]"
              >
            ...
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current hover:text-[#FF0000]"
              >
            ...
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current hover:text-[#1877F2]"
              >
